...
fn main() {
    ...
    let vertex_data = vec![
        ...
        Vertex::new([1, 1, 1], [1, 1]), //2
        Vertex::new([-1, 1, 1], [0, 1]), //3
        //bottom (0, 0, -1)
        Vertex::new([1, 1, -1], [0, 0]), //4
        Vertex::new([-1, 1, -1], [1, 0]), //5
        Vertex::new([-1, -1, -1], [1, 1]),//6
        Vertex::new([1, -1, -1], [0, 1]), //7
        // //right (1, 0, 0)
        // Vertex::new([1, -1, -1], [0, 0]), //7
        // Vertex::new([1, 1, -1], [1, 0]), //4
        // Vertex::new([1, 1, 1], [1, 1]), //2
        // Vertex::new([1, -1, 1], [0, 1]), //1
        // //left (-1, 0, 0)
        // Vertex::new([-1, 1, 1], [0, 0]), //3
        // Vertex::new([-1, -1, 1], [1, 0]), //0
        // Vertex::new([-1, -1, -1], [1, 1]), //6
        // Vertex::new([-1, 1, -1], [0, 1]), //5
        // //front (0, 1, 0)
